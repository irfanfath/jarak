<?php  
 $sumber = 'biodata.json'; 
 // kalo udah online tinggal masukin linknya
                                                ...
                                                <tr>
                                                    <?php   
                                                       for($a=0; $a < count($data); $a++)
                                                       {
                                                        ...
                                                        print "<td>".$data[$a]['detakjantung']."</td>";
                                                        print "<td>".$data[$a]['Longitude']."</td>";
                                                        print "<td>".$data[$a]['Latitude']."</td>";
                                                        print "<td>".$data[$a]['jarak']."</td>";
                                                        print "</tr>";
                                                       }
                                                      ?>
                                                </tr>
